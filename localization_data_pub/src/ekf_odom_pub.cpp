...
const double TICKS_PER_REVOLUTION = 2400; // For reference purposes.
const double WHEEL_RADIUS = 0.15; // Wheel radius in meters
const double WHEEL_BASE = 0.845; // Center of left tire to center of right tire
const double TICKS_PER_METER = 2548; // Original was 2800
